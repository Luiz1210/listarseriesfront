...
import logo from '../assets/image/imagem.jpg';
    ...
    <nav className={`navbar ${darkMode ? "navbar-dark" : "navbar-light"} navbar-transparent`}>
      <div className="navbar-container">
        ...
        <div className="navbar-links">
          <Link to="/catalogo" tabIndex={0} aria-label="link para a página principal de listar séries">
            Catálogo
          </Link>
          <Link to="/indicar-serie" tabIndex={0} aria-label="link para adicionar séries">
            Indicar Série
          </Link>
        </div>
        <button
